...
public class putAlert extends AppCompatActivity {
    ...
    String lat2,lng2;
    LocationManager lm;
    private static final String URL = "http://192.168.0.5/ProjectJ/insert.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        voicebutton = (Button) findViewById(R.id.voiceBut);

        editTextEvent = (EditText)findViewById(R.id.editIuput);
